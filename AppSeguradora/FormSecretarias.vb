...
Public Class FormSecretarias
    ...
    Private Sub refrescar()
        ...
        Command.CommandText = "SeguradoraSaude.GetSecretaryList"
    ...
    Private Sub inserir()
        ...
        Try
            ...
            com.CommandText = "SeguradoraSaude.NewSecretary"
            com.CommandType = CommandType.StoredProcedure

            com.Parameters.Add(New SqlParameter("@secretaryNIF", txt_nif.Text))
    ...
    Private Sub carregar(ByVal nif As Long)
        ...
        Dim com As SqlCommand = New SqlCommand()
        com.Connection = Me._con
        com.CommandText = "SeguradoraSaude.GetSecretaryNIF"
        com.CommandType = CommandType.StoredProcedure
        com.Parameters.Add(New SqlParameter("@secretaryNIF", nif))
